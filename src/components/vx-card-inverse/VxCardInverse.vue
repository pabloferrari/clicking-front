...
========================================================================================== -->
 ...
 <template>
    <div class="vx-card" ref="card" :class="[
        ...
        v-on="$listeners">
        <div class="vx-card__header vc-inverse" v-if="hasHeader">

            <!-- card title -->
            <div class="vx-card__title">
                <h6 v-if="this.$props.supratitle" :style="subtitleStyles" :class="subtitleClasses">{{ supratitle }}</h6>
