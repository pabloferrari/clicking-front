        ...
        <div slot="no-body" class="full-page-bg-color">
          <div class="vx-row no-gutter justify-center items-center">
            <div class="vx-col sm:w-full md:w-full lg:w-full d-theme-dark-bg">
              ...
              <div v-if="login" class="p-10 mb-12 login-tabs-container">
                ...
                <form>
                  <div class="mb-12">
                    ...
                    <vx-input-group class="w-full mt-6 mb-2">
                      ...
                      <template slot="append">
                        <div
                          ...
                          v-bind:class="{
                            'pt-5': !errors.has('password'),
                            'pt-3': errors.has('password')
                          }"
                        >
                          <vs-button
                            v-if="!showPassword"
                    ...
                    <div
                      class="flex flex-wrap justify-center my-5 mb-6 alt-text"
                    >
                      ¿Olvidaste tu contraseña? &nbsp;<a @click="forgot()"
                        ><b>Click aqui</b></a
                      >
                    </div>
                  </div>
                  ...
                  <div class="vx-row">
                    <div class="vx-col px-12 w-full ml-auto">
                      <vs-button
                        class="w-full mr-3 mb-2 vs-con-loading__container"
              ...
              <div
                v-if="forgotPassword"
                class="p-10 mb-12 login-tabs-container"
              >
                <div class="vx-card__title mb-12 sm:w-full">
                  <p class="mb-4 text-primary title">
                    Reestablecé la contraseña
                  </p>
                </div>
