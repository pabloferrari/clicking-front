  ...
  <div class="parentx">
    ...
    <vs-sidebar
      ...
      <div @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        ...
        <!-- Header -->
        <div class="header-sidebar flex items-end justify-between pt-12" slot="header">

          <!-- Logo -->
          <router-link tag="div" class="vx-logo cursor-pointer flex items-center" to="/">
            <!-- <logo class="w-10 mr-4 fill-current text-primary" /> -->
            <logo-clicking class="w-12 mr-2 fill-current text-primary" />
            <logo-clicking-text v-show="isMouseEnter || !reduce" class="fill-current mt-2 text-primary" />
        ...
        <!-- Menu Items -->
        <component :is="scrollbarTag" ref="verticalNavMenuPs" class="scroll-area-v-nav-menu pt-12" :settings="settings" @ps-scroll-y="psSectionScroll" @scroll="psSectionScroll" :key="$vs.rtl">
...
import LogoClicking from '../LogoClicking'
import LogoClickingText from '../LogoClickingText'
